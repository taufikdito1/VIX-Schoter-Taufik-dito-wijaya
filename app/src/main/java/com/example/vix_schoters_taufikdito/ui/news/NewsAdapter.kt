...
import com.example.vix_schoters_taufikdito.databinding.ItemNewsBinding
import com.example.vix_schoters_taufikdito.ui.news.NewsAdapter.MyViewHolder
import com.example.vix_schoters_taufikdito.ui.detail.DetailNewsActivity
import com.example.vix_schoters_taufikdito.utils.DateFormatter

class NewsAdapter(private val onBookmarkClick: (NewsEntity) -> Unit) : ListAdapter<NewsEntity, MyViewHolder>(
    DIFF_CALLBACK
) {
